...
import com.bigdata.social.vo.WokWechatUserInfo;
...
@Slf4j
@Api(tags = "企业微信登录接口")
@RequestMapping("/bigdata/social/workwechat")
@Controller
public class WorkWechatController {
    ...
    private static final Integer TYPE = SocialConstant.SOCIAL_TYPE_WORKWECHAT;
