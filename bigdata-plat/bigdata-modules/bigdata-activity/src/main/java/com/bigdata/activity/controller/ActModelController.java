...
import com.bigdata.activity.service.ActModelService;
...
@RestController
@Api(tags = "模型管理接口")
@RequestMapping(value = "/bigdata/actModel")
@Transactional
public class ActModelController {
    ...
    public Result addModel(ActModel actModel) {
    ...
    public Result deployByFile(@RequestParam MultipartFile file) {
    ...
    public void export(@PathVariable String id, HttpServletResponse response) {
        ...
        try {
            ...
            if (nodeBytes == null) {
                throw new BigdataException("导出失败，模型数据为空");
            }
            ...
            log.error(e.toString());
            throw new BigdataException("导出模型出错");
        }
    }
