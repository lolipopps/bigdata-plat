...
import com.bigdata.generator.bean.Entity;
import com.bigdata.generator.bean.Item;
...
import static com.bigdata.generator.BigdataGenerator.*;
 ...
 */
@Slf4j
public class BigdataMPGenerator {
     ...
     * (文件自动生成至该包下)
     */
    private static final String ENTITY_PACKAGE = "com.bigdata." + MODULE_PACKAGE + ".entity";

    /**
     * dao对应包 【注意修改后需到com.bigdata.core.config.mybatisplus.MybatisPlusConfig配置你的mapper路径扫描】
     * (文件自动生成至该包下)
     */
    private static final String DAO_PACKAGE = "com.bigdata." + MODULE_PACKAGE + ".mapper";

    /**
     * service对应包
     * (文件自动生成至该包下)
     */
    private static final String SERVICE_PACKAGE = "com.bigdata." + MODULE_PACKAGE + ".service";

    /**
     * serviceImpl对应包
     * (文件自动生成至该包下)
     */
    private static final String SERVICE_IMPL_PACKAGE = "com.bigdata." + MODULE_PACKAGE + ".serviceimpl";

    /**
     * controller对应包
     * (文件自动生成至该包下)
     */
    private static final String CONTROLLER_PACKAGE = "com.bigdata." + MODULE_PACKAGE + ".controller";
