package com.bigdata.quartz.controller;
...
import com.bigdata.quartz.service.QuartzJobService;
...
@RestController
@Api(tags = "定时任务管理接口")
@RequestMapping("/bigdata/quartzJob")
@Transactional
public class QuartzJobController {
    ...
    public Result pauseJob(QuartzJob job) {
        ...
        try {
            ...
            throw new BigdataException("暂停定时任务失败");
        }
    ...
    public Result resumeJob(QuartzJob job) {
        ...
        try {
            ...
            throw new BigdataException("恢复定时任务失败");
        }
        job.setStatus(CommonConstant.STATUS_NORMAL);
        quartzJobService.update(job);
    ...
    public void add(String jobClassName, String cronExpression, String parameter) {
        ...
        try {
            ...
            throw new BigdataException("创建定时任务失败");
        } catch (Exception e) {
            throw new BigdataException("后台找不到该类名任务");
        }
    }
    ...
    public void delete(String jobClassName) {
        ...
        try {
            ...
            throw new BigdataException("删除定时任务失败");
        }
    }
