package com.bigdata.open.controller;

import com.bigdata.core.common.annotation.SystemLog;
import com.bigdata.core.common.constant.OAuthConstant;
...
import com.bigdata.open.service.ClientService;
import com.bigdata.open.vo.Oauth2TokenInfo;
...
public class Oauth2Controller {
    ...
    public Result info(@ApiParam("客户端id") @PathVariable String client_id) {
    ...
    public Result authorize(@ApiParam("用户名") @RequestParam String username,
    ...
    public Result token(@ApiParam("授权类型") @RequestParam String grant_type,
                                @ApiParam("客户端id") @RequestParam String client_id,
    ...
    public Result authorized(@ApiParam("客户端id") @RequestParam String client_id,
                                     @ApiParam("成功授权后回调地址") @RequestParam String redirect_uri,
                                     @ApiParam("客户端状态值") @RequestParam String state) {
    ...
    public Result user(@ApiParam("令牌") @RequestParam String access_token) {
    ...
    private Client getClient(String client_id) {
        ...
        if (client == null) {
            throw new BigdataException("客户端client_id不存在");
        }
        return client;
    }
}
