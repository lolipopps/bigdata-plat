package com.bigdata.connect.constants.db;



import com.bigdata.connect.constants.DataSourceTypes;

import static com.bigdata.connect.constants.DataSourceTypes.ds_doris;

public class DorisConstants extends SQLConstants {

    public static final String KEYWORD_TABLE = ds_doris.getKeywordPrefix() + "%s" + ds_doris.getKeywordSuffix();
