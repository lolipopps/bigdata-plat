package com.bigdata.your;

import com.bigdata.core.common.annotation.RateLimiter;
import com.bigdata.core.common.lock.Callback;
import com.bigdata.core.common.lock.RedisLockTemplate;
...
@Api(tags = "测试接口")
@Transactional
@RequestMapping(value = "/bigdata/test")
