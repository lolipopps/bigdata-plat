...
import com.bigdata.core.service.*;
...
public class UserController {
    ...
    public Result resetPass(@RequestParam String[] ids) {
        ...
        for (String id : ids) {
            ...
            if ("test".equals(u.getUsername()) || "test2".equals(u.getUsername()) || "admin".equals(u.getUsername())) {
                throw new BigdataException("测试账号及管理员账号不得重置");
            }
    ...
    public Result disable(@ApiParam("用户唯一id标识") @PathVariable String userId) {
    ...
    public Result enable(@ApiParam("用户唯一id标识") @PathVariable String userId) {
