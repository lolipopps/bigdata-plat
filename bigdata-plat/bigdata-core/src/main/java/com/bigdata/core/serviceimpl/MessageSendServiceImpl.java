...
import com.bigdata.core.dao.MessageDao;
import com.bigdata.core.dao.MessageSendDao;
...
public class MessageSendServiceImpl implements MessageSendService {
    ...
    public void deleteByUserId(String userId) {
        ...
        messageSendDao.deleteByUserId(userId, MessageConstant.MESSAGE_STATUS_READ);
    }
    ...
    public Message getTemplateMessage(String messageId, Map<String, String> params) {
        ...
        if (message == null) {
            throw new BigdataException("消息ID：" + messageId + "不存在");
        }
        // 放入变量
