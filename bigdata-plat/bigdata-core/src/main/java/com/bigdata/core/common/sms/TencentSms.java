...
import com.bigdata.core.vo.SmsSetting;
...
public class TencentSms implements Sms {
    ...
    public SmsSetting getSmsSetting() {
        ...
        if (setting == null || StrUtil.isBlank(setting.getValue())) {
            throw new BigdataException("您还未配置腾讯云短信服务");
        }
    ...
    public void sendSms(String mobile, String params, String templateCode) {
        ...
        try {
            ...
            if (!"Ok".equals(sendStatus.getCode())) {
                throw new BigdataException("请求发送验证码失败，" + sendStatus.getMessage());
            }
        } catch (TencentCloudSDKException e) {
            throw new BigdataException("请求发送验证码失败，错误码：" + e.getErrorCode());
        }
    }
