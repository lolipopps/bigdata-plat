package com.bigdata.core.common.i18n;
    ...
    public static Object translateObject(Object javaObject) {
        ...
        try {
            if (javaObject instanceof String) {
                ...
                if (StringUtils.contains(rawString, JSON_SYMBOL)) {
                    try {
                        ...
                        log.error("Failed to translate object: " + rawString, e);
                        e.printStackTrace();
                        log.warn("Failed to translate object " + rawString + ". Error: " + ExceptionUtils.getStackTrace(e));
            ...
            try {
                ...
                log.error("Failed to translate object " + javaObject.toString(), e);
                return javaObject;
            }
        }
    }
