...
import com.bigdata.core.common.vo.TokenMember;
import com.bigdata.core.common.vo.TokenUser;
...
import com.bigdata.core.dao.MemberDao;
...
import com.bigdata.core.entity.*;
import com.bigdata.core.service.mybatis.IUserRoleService;
import com.bigdata.core.vo.PermissionDTO;
...
public class SecurityUtil {
    ...
    public String getToken(String username, Boolean saveLogin) {
        ...
        if (StrUtil.isBlank(username)) {
            throw new BigdataException("username不能为空");
        }
    ...
    public String getToken(User user, Boolean saveLogin) {
        ...
        if (user == null) {
            throw new BigdataException("user不能为空");
        }
        if (UserConstant.USER_STATUS_LOCK.equals(user.getStatus())) {
            throw new BigdataException("账户被禁用，请联系管理员");
        }
        Boolean saved = false;
    ...
    public User getCurrUser() {
        ...
        if (authentication == null || !authentication.isAuthenticated() || authentication.getName() == null
            ...
            throw new BigdataException("未检测到登录用户");
        }
    ...
    public String getAppToken(Member member, Integer platform) {
        ...
        if (member == null) {
            throw new BigdataException("member不能为空");
        }
    ...
    public Member getCurrMember() {
        ...
        if (authentication == null || !authentication.isAuthenticated() || authentication.getName() == null
                || authentication instanceof AnonymousAuthenticationToken) {
            throw new BigdataException("未检测到登录会员");
        }
