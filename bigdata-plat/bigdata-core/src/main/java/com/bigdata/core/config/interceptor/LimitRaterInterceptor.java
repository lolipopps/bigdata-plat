package com.bigdata.core.config.interceptor;
...
import com.bigdata.core.config.properties.BigdataIpLimitProperties;
import com.bigdata.core.config.properties.BigdataLimitProperties;
...
public class LimitRaterInterceptor extends HandlerInterceptorAdapter {
    ...
    @Autowired
    private BigdataLimitProperties limitProperties;

    @Autowired
    private BigdataIpLimitProperties ipLimitProperties;
