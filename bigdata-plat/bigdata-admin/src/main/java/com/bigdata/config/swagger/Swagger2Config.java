package com.bigdata.config.swagger;
...
public class Swagger2Config {
    ...
    @Value("${swagger.termsOfServiceUrl:http://bigdata.cn}")
    private String termsOfServiceUrl;

    @Value("${swagger.group:Bigdata v1.0}")
    private String group;

    @Value("${swagger.group2:Bigdata2 v1.0}")
    private String group2;

    @Value("${swagger.contact.name:Bigdata}")
    private String name;

    @Value("${swagger.contact.url:http://bigdata.cn}")
    private String url;

    @Value("${swagger.contact.email:269016084@qq.com}")
