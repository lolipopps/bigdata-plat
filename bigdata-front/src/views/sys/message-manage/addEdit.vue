      ...
      >
        ...
        <FormItem style="margin-bottom: 5px" v-show="form.isTemplate">
          <Alert show-icon
            ...
            <a
              href="https://www.kancloud.cn/bigdata/bigdata/1021404"
              target="_blank"
              >详见开发文档</a
            ></Alert
          >
        </FormItem>
        <FormItem label="内容" prop="content" class="form-noheight">
...
import editor from "@/views/my-components/bigdata/editor";
  ...
  data() {
    return {
      ...
      formValidate: {
        // 表单验证规则
        type: [
          { required: true, message: "消息请选择类型", trigger: "change" },
        ],
