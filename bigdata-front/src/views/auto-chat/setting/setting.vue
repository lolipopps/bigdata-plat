            ...
            <div style="position: relative">
              ...
              >
                <div v-show="tabName == 'basic'">
                  ...
                  <FormItem label="初始富文本消息" prop="initMessage" class="form-noheight">
                    <editor
                      id="initMessage"
                ...
                <div v-show="tabName == 'notice'">
                  ...
                  <FormItem label="公告内容" prop="noticeContent" class="form-noheight">
                    <editor
                      id="noticeContent"
                ...
                <div v-show="tabName == 'system'">
                  <FormItem label="未找到任何匹配回答的答复" prop="noDataReply" class="form-noheight">
                    <editor
                      id="noDataReply"
